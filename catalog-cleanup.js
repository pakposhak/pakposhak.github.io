...
let del = 0, footDel = 0, footMove = 0, fwdN = 0, revN = 0, pieceN = 0;
const out = [];
for (const p of ps) {
...
console.log(`delete-accessories=${del} delete-men-footwear=${footDel} move-footwear=${footMove} fwd-unstitch=${fwdN} rev-stitch=${revN} piece-count=${pieceN}`);
