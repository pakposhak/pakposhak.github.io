  ...
  function psFitRun(){
    ...
    psFitSaveProfile();
    psVisualLoad(true);
    var _fac=new AbortController(); var _ftid=setTimeout(function(){ _fac.abort(); },15000);
    fetch(psSearchBase()+'/fit?'+params+'&pageSize=60', { cache:'default', signal:_fac.signal })
      ...
      .catch(function(e){ clearTimeout(_ftid); psVisualLoad(false); console.warn('fit search failed:', e.message); psVisualToast(tr('fit_err')); });
  }
  ...
  const PSB_BUILD = '2026-06-30-stalefix';
