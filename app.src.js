  ...
  // Mirrored as a Set in build-search-db.js (BD_FAMOUS there) to also lead the Studio PRODUCT
  // grid itself (req 2026-07-02) — keep both lists in sync.
  const BD_FAMOUS = [
  ...
  const PSB_BUILD = '2026-07-02-desktop2';
