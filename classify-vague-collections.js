...
function classifyFromString(raw, col, brandName){
  ...
  const sl=s;
  if(FOOT_RE.test(sl)) return 'footwear';   // traditional footwear → Footwear (Women)
...
const KEEP_FOOT=/\b(khussa|khussas|khusa|khusse|chappal|chappals|chuppal|chuppa|kulapuri|kulapori|kolapuri|kolhapuri|kohlapuri|peshawari|peshawaris|mojari|mojaris|\bjutti\b)\b/i;
const FOOT_RE=/\bkhussas?\b|\bkhusa\b|\bkhusse\b|\bchappals?\b|\bchapals?\b|\bchuppals?\b|\bchuppa\b|\bkulapuris?\b|\bkulaporis?\b|\bkolapuris?\b|\bkolhapuris?\b|\bkohlapuris?\b|\bpeshawaris?\b|\bmojaris?\b|\bjuttis?\b|\bjutties\b|\bfootwear\b/i;
